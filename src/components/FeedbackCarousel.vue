  ...
  data() {
    return {
      reviews: [
        ...
        { id: 3, name: 'Christian A', comment: 'Beau projet les gars ! Ne lachez rien ! On a hate de voir la suite... 😉', stars: 4 },
        { id: 4, name: 'Anonyme', comment: 'Bonjour ! Ca fait plaisir de voir que le projet avance 😁 les dessins sont très réussis ! Je suis sûr que cela plaira à plus d’un !👍', stars: 4 },
        ...
        { id: 6, name: 'Pauline H', comment: 'Je te souhaite que sa fonctionne et sa va le faire avec de belles illustrations comme j’ai vue sa peut que marcher', stars: 4 }
      ],
      cardsToShow: 4,
      translateX: 0,
      animationFrame: null,
